...
+ It compiled with TBB lib selected as threading lib, so you will need to install it.
...
Last successfully tested with dldt-2019_R1.1, opencv-4.1.0, ffmpeg-3.2.14
